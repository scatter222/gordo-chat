...
var uri = process.env.MONGODB_URI || 'mongodb://admin:admin123@localhost:27017/gordo-chat?authSource=admin';
...
var MONGODB_URI = process.env.MONGODB_URI || 'mongodb://admin:admin123@localhost:27017/gordo-chat?authSource=admin';
if (!MONGODB_URI) {
    throw new Error('Please define the MONGODB_URI environment variable');
}
